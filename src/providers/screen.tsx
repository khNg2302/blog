...
const ScreenContext = createContext<StoreApi<
  ScreenStoreStateType & ScreenStoreActionType
> | null>(null);
...
export const useScreenStore = <T,>(
  selector: (state: ScreenStoreStateType & ScreenStoreActionType) => T
) => {
