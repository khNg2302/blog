...
export const DisplayScrollItem = forwardRef<HTMLDivElement, DisplayScrollItemI>(({ children, displayItemClassname, overflowBoxClassname }, ref) => {
    return <DisplayItem ref={ref} className={cn("overflow-auto flex-1 w-full", overflowBoxClassname)}>
